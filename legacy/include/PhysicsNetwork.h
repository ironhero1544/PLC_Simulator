...
typedef struct ElectricalNetworkFunctions {
    ...
    int (*AddNode)(ElectricalNetwork* network, const NetworkNodeBase* nodeBase, const ElectricalNode* electricalNode);
    int (*RemoveNode)(ElectricalNetwork* network, int nodeId);
    int (*AddEdge)(ElectricalNetwork* network, const NetworkEdgeBase* edgeBase, const ElectricalEdge* electricalEdge);
...
typedef struct PneumaticNetworkFunctions {
    ...
    int (*AddNode)(PneumaticNetwork* network, const NetworkNodeBase* nodeBase, const PneumaticNode* pneumaticNode);
    int (*RemoveNode)(PneumaticNetwork* network, int nodeId);
    int (*AddEdge)(PneumaticNetwork* network, const NetworkEdgeBase* edgeBase, const PneumaticEdge* pneumaticEdge);
...
typedef struct MechanicalSystemFunctions {
    ...
    int (*AddNode)(MechanicalSystem* system, const NetworkNodeBase* nodeBase, const MechanicalNode* mechanicalNode);
    int (*RemoveNode)(MechanicalSystem* system, int nodeId);
    int (*AddEdge)(MechanicalSystem* system, const NetworkEdgeBase* edgeBase, const MechanicalEdge* mechanicalEdge);
