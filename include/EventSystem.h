...
typedef struct EventDispatcher {
    ...
    // 함수 포인터들
    bool (*Subscribe)(struct EventDispatcher* dispatcher, EventType type, EventCallback callback, void* userData);
    bool (*Unsubscribe)(struct EventDispatcher* dispatcher, EventType type, EventCallback callback);
    void (*Dispatch)(struct EventDispatcher* dispatcher, const EventData* eventData);
...
EventData CreateIOMappingUpdatedEvent(int mappingCount, int inputCount, int outputCount, bool success, void* mappingPtr); // Phase 2
